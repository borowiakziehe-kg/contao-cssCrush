...
$GLOBALS['TL_LANG']['tl_layout']['useCssCrush'] = array('CSS Typ wählen', 'Bitte wählen Sie wie CSS Dateien in das Layout geladen werden sollen.');
...
$GLOBALS['TL_LANG']['tl_layout']['cssCrushVersioning'] = array('Versionierung aktivieren', 'Sollen die CSS Dateien als Backup versioniert abgelegt werden? (Caching Hilfe)');
